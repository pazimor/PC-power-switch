...
async fn wifi_task(
    runner: cyw43::Runner<'static, Output<'static, PIN_23>, pin::PioSpi<'static, PIN_25, PIO0, 0, DMA_CH0>>,
) -> ! {
    runner.run().await
}
...
async fn main(spawner: Spawner) {
    ...
    let spi = pin::PioSpi::new(&mut pio.common, pio.sm0, pio.irq0, cs, p.PIN_24, p.PIN_29, p.DMA_CH0);
